    ...
    stages {
        ...
        jdk 'openlogic-openjdk-8u342-b07-linux'
            ...
            steps {
                ...
                sh ("jf rt upload --url http://192.168.31.13:8082//artifactory/ --access-token $ARTIFACTORY_ACCESS_TOKEN /var/lib/jenkins/workspace/test_maven_main_2/target/lavagna-1.1.10-SNAPSHOT-distribution.zip test/")
